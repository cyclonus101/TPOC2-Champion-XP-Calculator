...
;for 2*,2.5*,3*
sevenbattleadventureratio := [.025,.051,.4,.555,.675,.8,1]

zedlong := [25,50,175,520,665,790,915,1110]
viktorshort := [35,70,565,780,960,1245]

weekly3halfXP    := [75,150,1230,1695,2045,2395,3015]
weekly4xp        := [95,190,1505,1920,2185,2450,3200]
